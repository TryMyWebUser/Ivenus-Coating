                  ...
                  <div class="row justify-content-center">
                     <div class="col-12 col-xl-5">
                        <div class="section__header text-center">
                           ...
                           <h2 class="title-animation">Our Vison & Mission</h2>
                  ...
                  <div class="row vertical-column-gap-lg justify-content-center">
                     <div class="col-lg-6">
                        <div class="service__single" data-aos="fade-up" data-aos-duration="1200">
                           <div class="thumb">
                           <img src="assets/images/icon/6.png" alt="Image" class="filter-img">
                           </div>
                           <div class="content">
                              <h4><a href="#0">Our Vision</a></h4>
                           <p class="m-0">1. To lead the industry in corrosion awareness and prevention through education and innovation.</p>
                           <p class="m-0">2. To lead the industry in corrosion awareness and prevention through education and innovation.</p>
                           <p class="m-0">3. To consistently exceed customer expectations by delivering excellence in execution, quality, and safety.</p>
                           <p>4. To enhance shareholder value by developing innovative solutions, outperforming industry standards, and fostering a dynamic and challenging work environment for our team.</p>
                           </div>
                           <div class="bg-thumb">
                              <img src="assets/images/background/service-bg-sm.png" alt="Image">
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6">
                        <div class="service__single" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
                           <div class="thumb">
                           <img src="assets/images/icon/5.png" alt="Image" class="filter-img">
                           </div>
                           <div class="content">
                              <h4><a href="properties-grid-view.html">Our Mission</a></h4>
                              <p class="m-0">1. To act with integrity and remain true to our values and ethics in everything we do.</p>
                              <p class="m-0">2. To prioritize safety, protect the environment, and support the communities in which we operate.</p>
                              <p class="m-0">3. To build lasting relationships founded on trust and confidence—our most valuable assets.</p>
                              <p class="m-0">4. To deliver the highest level of commitment to quality in our products and services.</p>
                              <p class="m-0">5. To inspire and empower our employees to uphold and pursue our corporate mission in their daily work.</p>
                           </div>
                           <div class="bg-thumb">
                              <img src="assets/images/background/service-bg-sm.png" alt="Image">
                           </div>
                        ...
                        <div class="team-details__content">
                           <div class="about-me m-0">
                              <div class="about-me__header">
                                 <h4 class="title-animation">Quality Parameters</h4>
                              </div>
                              <div class="about-me__content" data-aos="fade-up" data-aos-duration="1200">
                                 <p>•	Our services are delivered by trained and experienced professionals, ensuring that timelines and quality remain our highest priorities.</p>
                                 <p>•	We actively listen to client specifications and are committed to meeting their expectations with efficiency and precision.</p>
                                 <p>•	We uphold a zero-compromise policy on quality—this is a core value that guides every aspect of our work.</p>
                                 <p>•	At Ivenus Coating and Engineering, quality is not just a standard—it's a tradition. We are committed to continuous improvement through stage-by-stage quality checks and regular refresher training programs.</p>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="container">
                  <!-- <div class="row justify-content-center">
                     <div class="col-12">
                        <div class="section__header text-center">
                           <span>Ivenus Coating and Engineering</span>
                           <h2 class="title-animation">Build your Business</h2>
                           <div class="icon-thumb justify-content-center">
                              <div class="icon-thumb-single">
                                 <span></span>
                                 <span></span>
            ...
            <section class="team-details">
               <div class="container">
                  <div class="row vertical-column-gap-lg">
                     <div class="col-12 col-lg-5">
                        <div class="team-details__thumb p-0" data-aos="fade-up" data-aos-duration="1200">
                           <img src="assets/images/team/two1.png" style="height: 28rem; border-radius: 2rem; object-fit: fill;" alt="Image">
                        </div>
                     </div>
                     <div class="col-12 col-lg-7 align-content-center">
                        <div class="team-details__content">
                           <div class="about-me m-0">
                              <div class="about-me__header">
                                 <h3 class="title-animation"><b>Safety Parameters</b></h3>
                              </div>
                              <div class="about-me__content" data-aos="fade-up" data-aos-duration="1200">
                                 <li> We are committed to maintaining the highest safety standards throughout every stage of execution and painting operations.</li>
                                 <li> Our goal is to achieve incident-free workplaces by focusing on three key pillars: </li>
                                 <ul>
                                    <li> <b>Health: </b> Ensuring the well-being of all personnel through proactive medical monitoring and wellness practices.</li>
                                    <li> <b>Safety: </b> Enforcing strict adherence to safety protocols, PPE usage, and hazard mitigation measures.</li>
                                    <li> <b>Environmental Protection: </b> Minimizing environmental impact through responsible practices, waste management, and compliance with environmental regulations.</li>
                                    <li> <b>Awareness of Safety: </b> Promoting a culture of safety through regular training, toolbox talks, and awareness campaigns, ensuring every employee is alert, informed, and accountable.</li>
                                 </ul>
                              </div>
                           </div>
